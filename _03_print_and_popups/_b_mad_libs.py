...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring(title="adjective",prompt="enter an adjective")
    # Get the player to enter a type of liquid
    liq = simpledialog.askstring(title="liquid",prompt="enter a type of liquid")
    # Get the player to enter a body part
    bodpart = simpledialog.askstring(title="bodypart",prompt="enter a body part")
